...
namespace ConnectionModule
{
    public class CommonFunc
    {
        ...
        public readonly string spotConn = "Data Source=(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = 10.0.150.103)(PORT= 1521)) (CONNECT_DATA = (SERVICE_NAME = SPOTPROD.ktmb.com.my) (SID = SPOTPROD))); User Id=PRODOWN;Password=PRODOWN;";
