...
namespace emujv2Api.Model
{
    public class Lookup
    {
        ...
        public string RegMalay(string Region)
        {
            ...
            SqlStr.Append(" select a.kmuj_name, kmuj_value, b.region_name ");
            SqlStr.Append(" from kmuj as a, region as b ");
            SqlStr.Append(" where b.region_id = a.region_id ");
        ...
        public string GetAllFormDetails(string RptCode)
        {
            ...
            SqlStr.Append(" SELECT ");
            SqlStr.Append("     b.region_name, ");
            SqlStr.Append("     c.kmuj_name, ");
            SqlStr.Append("     d.section_name, ");
            SqlStr.Append("     CONCAT('Gang ', a.daily_gang) AS Gang, ");
            SqlStr.Append("     CONVERT(VARCHAR(10), CONVERT(DATETIME, a.daily_date, 103), 23) AS daily_date, ");
            SqlStr.Append("     f.work_name, ");
            SqlStr.Append("     a.upd_user, ");
            SqlStr.Append("     a.daily_total, ");
            SqlStr.Append("     a.daily_unit, ");
            SqlStr.Append("     a.effect_kmfrom, ");
            SqlStr.Append("     a.effect_kmto, ");
            SqlStr.Append("     a.effect_kmtotal, ");
            SqlStr.Append("     g.cond_name, ");
            SqlStr.Append("     h.branch_name, ");
            SqlStr.Append("     a.daily_workers, ");
            SqlStr.Append("     e.category_name, ");
            SqlStr.Append("     cd.details, ");
            SqlStr.Append("     a.daily_timestart, ");
            SqlStr.Append("     a.daily_timelast, ");
            SqlStr.Append("     a.daily_timetaken, ");
            SqlStr.Append("     a.station, ");
            SqlStr.Append("     a.station_point, ");
            SqlStr.Append("     a.daily_additional, ");
            SqlStr.Append("     a.rpt_code ");
            SqlStr.Append(" FROM ");
            SqlStr.Append("     daily_form AS a ");
            SqlStr.Append("     INNER JOIN region AS b ON a.daily_section = b.region_id ");
            SqlStr.Append("     INNER JOIN kmuj AS c ON a.daily_kmuj = c.kmuj_value ");
            SqlStr.Append("     INNER JOIN section AS d ON a.daily_sec = d.section_val ");
            SqlStr.Append("     INNER JOIN category AS e ON a.daily_category = e.category_id ");
            SqlStr.Append("     LEFT JOIN category_details AS cd ON a.category_details = cd.id ");
            SqlStr.Append("     INNER JOIN kerja AS f ON a.daily_worktype = f.id ");
            SqlStr.Append("     INNER JOIN condition AS g ON a.daily_condition = g.cond_id ");
            SqlStr.Append("     LEFT JOIN branch_line AS h ON a.branch_details = h.branch_id ");
            SqlStr.Append(" WHERE ");
            SqlStr.Append("     a.rpt_code = @RptCode ");
            SqlStr.Append(" ORDER BY ");
            SqlStr.Append("     CONVERT(DATETIME, a.daily_date, 103) DESC ");
